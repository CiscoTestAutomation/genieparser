                    ...
                    'ipv4': {
                        ...
                        'routes': {
                            '1.1.1.1/32': {
                                ...
                                'next_hop': {
                                    'outgoing_interface': {
                                        'GigabitEthernet0_0_0_3': {
                                            'active': True,
                                            'outgoing_interface': 'GigabitEthernet0_0_0_3',
                                            'install_date': 'Dec  7 21:52:00.853',
                                            'metrics': '[0/4096/1/0/1]',
                                            'path_version': 1,
                                            'path_status': '0x21',
                                            'tag':0,
                                        },
                                        'GigabitEthernet0_0_0_0': {
                                            'active': True,
                                            'outgoing_interface': 'GigabitEthernet0_0_0_0',
                                ...
                                'next_hop': {
                                    'next_hop_list': {
                                        1: {
                                            ...
                                            'active': True,
                                            'next_hop': '20.2.3.3',
                                            'outgoing_interface': 'GigabitEthernet0_0_0_2',
                                        ...
                                        3: {
                                            ...
                                            'active': False,
                                            'next_hop': '10.2.3.3',
                                            'outgoing_interface': 'GigabitEthernet0_0_0_1',
                                            'configure_date': 'Dec  7 21:47:43.624',
                                            'metrics': '[7/0/17/0/1]',
                                            'path_version': 0,
                                            'object': '1',
