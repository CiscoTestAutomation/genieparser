...
def get_operating_systems(_os):
    ...
    if _os:
        return [_os]
    return ["asa", "ios", "iosxe", "nxos", "junos"]
    # operating_system = []
...
CLASS_SKIP = {
    ...
    "nxos": {
        ...
        "ShowBgpPeerTemplate": True,
        "ShowBgpVrfAllAll": True,
        "ShowBgpVrfAllNeighbors": True,
        "ShowBgpVrfAllAllNextHopDatabase": True,
        "ShowBgpVrfAllAllSummary": True,
        "ShowBgpVrfAllAllDampeningParameters": True,
        "ShowBgpVrfAllNeighborsAdvertisedRoutes": True,
        "ShowBgpL2vpnEvpnNeighborsAdvertisedRoutes": True,
        "ShowBgpVrfAllNeighborsRoutes": True,
        "ShowBgpVrfAllNeighborsReceivedRoutes": True,
        "ShowRunningConfigBgp": True,
        "ShowBgpAllDampeningFlapStatistics": True,
        "ShowBgpAllNexthopDatabase": True,
        "ShowBgpPeerTemplateCmd": True,
        "ShowBgpPolicyStatisticsParser": True,
        "ShowBgpPolicyStatisticsRedistribute": True,
        "ShowBgpPolicyStatisticsNeighbor": True,
        "ShowBgpPolicyStatisticsDampening": True,
        "ShowBgpSessions": True,
        "ShowBgpLabels": True,
        "ShowBgpL2vpnEvpnSummary": True,
        "ShowBgpL2vpnEvpnRouteType": True,
        "ShowBgpL2vpnEvpnNeighbors": True,
        "ShowBgpL2vpnEvpnWord": True,
        "ShowBgpIpMvpnRouteType": True,
        "ShowBgpIpMvpnSaadDetail": True,
        "ShowBgpL2vpnEvpn": True,
        "ShowBgpIpMvpn": True,
        "ShowBgpVrfIpv4Unicast": True,
        "ShowEigrpNeighborsSuperParser": True,
        "ShowIpv4EigrpNeighbors": True,
        "ShowIpv6EigrpNeighbors": True,
        "ShowEigrpNeighborsDetailSuperParser": True,
        "ShowIpv4EigrpNeighborsDetail": True,
        "ShowIpv6EigrpNeighborsDetail": True,
        "ShowEigrpTopology": True,
        "ShowFabricpathIsisAdjacency": True,
        "ShowIpIgmpSnooping": True,
        "ShowIpIgmpInterface": True,
        "ShowIpIgmpGroups": True,
        "ShowIpIgmpLocalGroups": True,
        "ShowInterface": True,
        "ShowIpInterfaceVrfAll": True,
        "ShowVrfAllInterface": True,
        "ShowInterfaceSwitchport": True,
        "ShowIpv6InterfaceVrfAll": True,
        "ShowIpInterfaceBrief": True,
        "ShowIpInterfaceBriefPipeVlan": True,
        "ShowInterfaceBrief": True,
        "ShowRunningConfigInterface": True,
        "ShowNveInterface": True,
        "ShowIpInterfaceBriefVrfAll": True,
        "ShowInterfaceDescription": True,
        "ShowInterfaceStatus": True,
        "ShowIsis": True,
        "ShowIsisInterface": True,
        "ShowIsisSpfLogDetail": True,
        "ShowIsisAdjacency": True,
        "ShowIsisHostname": True,
        "ShowIsisHostnameDetail": True,
        "ShowIsisDatabaseDetail": True,
        "ShowL2routeEvpnMac": True,
        "ShowL2routeEvpnMacEvi": True,
        "ShowLacpSystemIdentifier": True,
        "ShowLacpCounters": True,
        "ShowLacpNeighbor": True,
        "ShowPortChannelSummary": True,
        "ShowPortChannelDatabase": True,
        "ShowLldpAll": True,
        "ShowLldpTimers": True,
        "ShowLldpTlvSelect": True,
        "ShowLldpNeighborsDetail": True,
        "ShowLldpTraffic": True,
        "ShowLoggingLogfile": True,
        "ShowIpMrouteVrfAll": True,
        "ShowIpv6MrouteVrfAll": True,
        "ShowIpStaticRouteMulticast": True,
        "ShowIpv6StaticRouteMulticast": True,
        "ShowForwardingDistributionMulticastRoute": True,
        "ShowIpv6MldInterface": True,
        "ShowIpv6MldGroups": True,
        "ShowIpv6MldLocalGroups": True,
        "ShowIpMsdpPeerVrf": True,
        "ShowIpMsdpSaCacheDetailVrf": True,
        "ShowIpMsdpPolicyStatisticsSaPolicyInOut": True,
        "ShowIpMsdpPolicyStatisticsSaPolicyIn": True,
        "ShowIpMsdpPolicyStatisticsSaPolicyOut": True,
        "ShowIpMsdpSummary": True,
        "ShowRunningConfigMsdp": True,
        "ShowIpv6NeighborDetail": True,
        "ShowIpv6NdInterface": True,
        "ShowIpv6IcmpNeighborDetail": True,
        "ShowIpv6Routers": True,
        "ShowNtpPeerStatus": True,
        "ShowNtpPeers": True,
        "ShowIpOspf": True,
        "ShowIpOspfMplsLdpInterface": True,
        "ShowIpOspfVirtualLinks": True,
        "ShowIpOspfShamLinks": True,
        "ShowIpOspfInterface": True,
        "ShowIpOspfNeighborDetail": True,
        "ShowIpOspfDatabaseExternalDetail": True,
        "ShowIpOspfDatabaseNetworkDetail": True,
        "ShowIpOspfDatabaseSummaryDetail": True,
        "ShowIpOspfDatabaseRouterDetail": True,
        "ShowIpOspfDatabaseOpaqueAreaDetail": True,
        "ShowIpv6PimInterface": True,
        "ShowPimRp": True,
        "ShowIpv6PimRp": True,
        "ShowIpPimRp": True,
        "ShowIpv6PimDf": True,
        "ShowIpPimDf": True,
        "ShowIpv6PimRoute": True,
        "ShowIpv6PimNeighbor": True,
        "ShowIpPimRoute": True,
        "ShowIpv6PimGroupRange": True,
        "ShowIpPimNeighbor": True,
        "ShowIpPimVrfDetail": True,
        "ShowIpPimGroupRange": True,
        "ShowIpPimPolicyStaticticsRegisterPolicy": True,
        "ShowIpPimInterface": True,
        "ShowIpv6PimVrfAllDetail": True,
        "ShowRunningConfigPim": True,
        "ShowVersion": True,
        "ShowInventory": True,
        "ShowInstallActive": True,
        "ShowRedundancyStatus": True,
        "ShowSystemRedundancyStatus": True,
        "ShowBoot": True,
        "ShowModule": True,
        "ShowVdcDetail": True,
        "ShowVdcCurrent": True,
        "ShowVdcMembershipStatus": True,
        "ShowProcessesMemory": True,
        "ShowProcessesCpu": True,
        "ShowCores": True,
        "ShowIpPrefixList": True,
        "ShowIpv6PrefixList": True,
        "ShowProcesses": True,
        "ShowIpRipVrfAll": True,
        "ShowIpRipRouteVrfAll": True,
        "ShowIpRipInterfaceVrfAll": True,
        "ShowIpv6RipVrfAll": True,
        "ShowIpv6RipRouteVrfAll": True,
        "ShowRouteMap": True,
        "ShowRoutingVrfAll": True,
        "ShowRoutingIpv6VrfAll": True,
        "ShowIpRouteSummary": True,
        "ShowIpRoute": True,
        "ShowIpv6Route": True,
        "ShowRouting": True,
        "ShowSpanningTreeMst": True,
        "ShowSpanningTreeSummary": True,
        "ShowSpanningTreeDetail": True,
        "ShowErrdisableRecovery": True,
        "ShowIpStaticRoute": True,
        "ShowIpv6StaticRoute": True,
        "ShowSystemInternalSysmgrServiceName": True,
        "ShowSystemInternalL2fwderMac": True,
        "ShowRunningConfigTrm": True,
        "ShowVdcResourceDetail": True,
        "ShowVirtualServiceGlobal": True,
        "ShowVirtualServiceList": True,
        "ShowVirtualServiceCore": True,
        "ShowVirtualServiceDetail": True,
        "ShowGuestshell": True,
        "ShowVirtualServiceUtilization": True,
        "ShowVlan": True,
        "ShowVlanIdVnSegment": True,
        "ShowVlanInternalInfo": True,
        "ShowVlanFilter": True,
        "ShowVlanAccessMap": True,
        "ShowVxlan": True,
        "ShowVpc": True,
        "ShowVrf": True,
        "ShowVrfInterface": True,
        "ShowVrfDetail": True,
        "ShowRunningConfigVrf": True,
        "ShowL2routeEvpnImetAllDetail": True,
        "ShowNvePeers": True,
        "ShowNveVniSummary": True,
        "ShowNveVni": True,
        "ShowNveInterface": True,
        "ShowNveInterfaceDetail": True,
        "ShowNveMultisiteDciLinks": True,
        "ShowNveMultisiteFabricLinks": True,
        "ShowNveEthernetSegment": True,
        "ShowL2routeEvpnEternetSegmentAll": True,
        "ShowL2routeTopologyDetail": True,
        "ShowL2routeMacAllDetail": True,
        "ShowL2routeMacIpAllDetail": True,
        "ShowL2routeSummary": True,
        "ShowL2routeFlAll": True,
        "ShowRunningConfigNvOverlay": True,
        "ShowNveVniIngressReplication": True,
        "ShowFabricMulticastGlobals": True,
        "ShowFabricMulticastIpSaAdRoute": True,
