...
class TestShowIpInterfaceVrfAll(unittest.TestCase):
    ...
    golden_output_4 = {'execute.return_value': '''
        ...
        WCCP Redirect inbound: disabled
        WCCP Redirect exclude: disabled
        Vlan200, Interface status: protocol-down/link-down/admin-up, iod: 3,
        IP address: 10.54.130.130, IP subnet: 10.54.130.128/29 route-preference: 0, tag: 0 
        IP broadcast address: 255.255.255.255
        IP multicast groups locally joined: 
            224.0.0.102  
        IP MTU: 1500 bytes (using link MTU)
        ...
        WCCP Redirect inbound: disabled
        WCCP Redirect exclude: disabled
        Ethernet1/7, Interface status: protocol-up/link-up/admin-up, iod: 20,
        IP address: 10.80.0.129, IP subnet: 10.80.0.128/31 route-preference: 0, tag: 0 
        IP broadcast address: 255.255.255.255
        IP multicast groups locally joined: none
        IP MTU: 1500 bytes (using link MTU)
        IP primary address route-preference: 0, tag: 0
        ...
        IP Interface Status for VRF "management"
        mgmt0, Interface status: protocol-up/link-up/admin-up, iod: 9,
        IP address: 10.30.115.23, IP subnet: 10.30.115.0/24 route-preference: 0, tag: 0 
        IP broadcast address: 255.255.255.255
        IP multicast groups locally joined: none
        IP MTU: 1500 bytes (using link MTU)
        IP primary address route-preference: 0, tag: 0
        ...
        IP interface statistics last reset: never
        IP interface software stats: (sent/received/forwarded/originated/consumed)
            Unicast packets    : 404850/168079/0/404850/336158
            Unicast bytes      : 228570993/9867506/0/228570993/19614038
            Multicast packets  : 0/393989/0/0/0
            Multicast bytes    : 0/22967821/0/0/0
            Broadcast packets  : 0/1335/0/0/0
            Broadcast bytes    : 0/104130/0/0/0
            Labeled packets    : 0/0/0/0/0
            Labeled bytes      : 0/0/0/0/0
        WCCP Redirect outbound: disabled
        WCCP Redirect inbound: disabled
        ...
        'mgmt0': {
            ...
            'ipv4': {
                ...
                'counters': {
                    ...
                    'broadcast_bytes_forwarded': 0,
                    'broadcast_bytes_originated': 0,
                    'broadcast_bytes_received': 104130,
                    'broadcast_bytes_sent': 0,
                    'broadcast_packets_consumed': 0,
                    'broadcast_packets_forwarded': 0,
                    'broadcast_packets_originated': 0,
                    'broadcast_packets_received': 1335,
                    'broadcast_packets_sent': 0,
                    'labeled_bytes_consumed': 0,
                    'labeled_bytes_forwarded': 0,
                    'labeled_bytes_originated': 0,
                    ...
                    'multicast_bytes_forwarded': 0,
                    'multicast_bytes_originated': 0,
                    'multicast_bytes_received': 22967821,
                    'multicast_bytes_sent': 0,
                    'multicast_packets_consumed': 0,
                    'multicast_packets_forwarded': 0,
                    'multicast_packets_originated': 0,
                    'multicast_packets_received': 393989,
                    'multicast_packets_sent': 0,
                    'unicast_bytes_consumed': 19614038,
                    'unicast_bytes_forwarded': 0,
                    'unicast_bytes_originated': 228570993,
                    'unicast_bytes_received': 9867506,
                    'unicast_bytes_sent': 228570993,
                    'unicast_packets_consumed': 336158,
                    'unicast_packets_forwarded': 0,
                    'unicast_packets_originated': 404850,
                    'unicast_packets_received': 168079,
                    'unicast_packets_sent': 404850,
                },
            },
            'load_sharing': 'none',
            'local_proxy_arp': 'disabled',
