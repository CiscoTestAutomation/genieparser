    ...
    "interfaces": {
        "Ethernet1/1": {
            "port_id": {
                "GigabitEthernet3": {
                    "neighbors": {
                        "R1_csr1000v.openstacklocal.open": {
                            "chassis_id": "001e.49ff.24f7.4e4w3",
                            "port_description": "GigabitEthernet3",
                            "system_name": "R1_csr1000v.openstacklocal.open",
                            "system_description": "Cisco IOS Software [Everest], Virtual XE Software (X86_64_LINUX_IOSD-UNIVERSALK9-M), Version 16.6.1, RELEASE SOFTWARE (fc2) and much MORE\nTechnical Support: http://www.cisco.com/techsupport\nCopyright (c) 1986-2017 by Cisco Systems, Inc.\nCompiled Sat 22-Jul-17 05:51 by",
                            "time_remaining": 114,
                            "capabilities": {
