...
class TestShowEnvironment(unittest.TestCase):
	...
	golden_parsed_output= {
	    ...
	    "power": {
	        ...
	        "power_usage_summary": {
	            "total_grid_a": 12000.0,
	            "total_grid_b": 6000.0,
	            "total_power_allocated": 10327.0,
	            "total_power_available": 7673.0,
	            "total_power_capacity": 18000.0,
	            "total_power_cumalative": 18000.0,
	            "total_power_input": 6003.0,
	            "total_power_output": 5637.0,
	        },
	        "voltage": 12,
	    },
	    "temperature": {
	...
	golden_parsed_output_1 = {
	    ...
	    "power": {
	        ...
	        "power_usage_summary": {
	            "total_grid_a": 0.0,
	            "total_grid_b": 650.0,
	            "total_power_capacity": 650.0,
	            "total_power_cumalative": 650.0,
	            "total_power_input": 140.0,
	            "total_power_output": 126.0,
	        },
	        "voltage": 12,
	    },
	    "temperature": {
...
class TestShowEnvironmentFan(unittest.TestCase):
	...
	golden_parsed_output = {   
	        'fans': {   'Fan1': {   'direction': 'front-to-back',
                        'hw': '--',
                        'model': '----------',
                        'status': 'Absent'},
            'Fan2': {   'direction': 'front-to-back',
                        'hw': '--',
                        'model': '----------',
                        'status': 'Absent'},
            'Fan3': {   'direction': 'front-to-back',
                        'hw': '--',
                        'model': '----------',
                        'status': 'Absent'},
	...
	golden_parsed_output_1 = {
	    "power": {
	        ...
	        "power_usage_summary": {
	            ...
	            "total_power_capacity": 18000.0,
	            "total_power_cumalative": 18000.0,
	            "total_power_input": 5943.0,
	            "total_power_output": 5591.0,
	        },
	        "voltage": 12,
	    }
	}
	...
	golden_parsed_output_1 = {
	    "power": {
	        ...
	        "power_usage_summary": {
	            ...
	            "total_power_capacity": 18000.0,
	            "total_power_cumalative": 18000.0,
	            "total_power_input": 5971.0,
	            "total_power_output": 5588.0,
	        },
	        "voltage": 12,
	    }
	}
