expected_output = {
    "ldp-session-information": {
        "ldp-session": {
            ...
            "ldp-neighbor-types": {"ldp-neighbor-type": "discovered"},
            "ldp-remaining-time": "0",
            "ldp-remote-helper-mode": "enabled",
            "ldp-remote-label-adv-mode": "Downstream unsolicited",
            "ldp-retry-interval": "1",
            "ldp-session-capabilities-advertised": {"ldp-capability": "none"},
            "ldp-session-capabilities-received": {"ldp-capability": "none"},
            "ldp-session-flags": {"ldp-session-flag": "none"},
            "ldp-session-id": "10.34.2.250:0--10.169.14.240:0",
            "ldp-session-max-pdu": "4096",
            "ldp-session-nsr-state": "Not in sync",
            "ldp-session-protection": {"ldp-session-protection-state": "disabled"},
