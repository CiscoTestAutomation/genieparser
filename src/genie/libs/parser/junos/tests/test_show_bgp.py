...
class TestShowBgpGroupBrief(unittest.TestCase):
    ...
    golden_parsed_output = {'bgp-group-information': {'bgp-group': [{'bgp-option-information': {'bgp-options': 'Confed',
                                                                     'bgp-options-extended': 'GracefulShutdownRcv',
                                                                     'export-policy': '(v4_WATARI '
                                                                                      '&& '
                                                                                      'NEXT-HOP-SELF)',
                                                                     'gshut-recv-local-preference': '0',
                                                                     'holdtime': '0'},
                                          'bgp-rib': {'accepted-prefix-count': '682',
                                          ...
                                          'peer-count': '1',
                                          'type': 'Internal'},
                                         {'bgp-option-information': {'bgp-options': 'Confed',
                                                                     'bgp-options-extended': 'GracefulShutdownRcv',
                                                                     'export-policy': '(v6_WATARI '
                                                                                      '&& '
                                                                                      'NEXT-HOP-SELF)',
                                                                     'gshut-recv-local-preference': '0',
                                                                     'holdtime': '0'},
                                          ...
                                          'peer-count': '1',
                                          'type': 'Internal'},
                                         {'bgp-option-information': {'bgp-options': 'Cluster '
                                                                                    'Confed',
                                                                     'bgp-options-extended': 'GracefulShutdownRcv',
                                         ...
                                         {'bgp-option-information': {'bgp-options': 'Cluster '
                                          ...
                                          'peer-count': '1',
                                          'type': 'Internal'},
                                         {'bgp-option-information': {'bgp-options': 'Multihop '
                                                                                    'Confed',
                                                                     'bgp-options-extended': 'GracefulShutdownRcv',
                                                                     'export-policy': '(ALL_out '
                                                                                      '&& '
                                         ...
                                         {'bgp-option-information': {'bgp-options': 'Multihop '
                                                                     ...
                                                                     'gshut-recv-local-preference': '0',
                                                                     'holdtime': '0'},
                                          'bgp-rib': {'accepted-prefix-count': '2',
