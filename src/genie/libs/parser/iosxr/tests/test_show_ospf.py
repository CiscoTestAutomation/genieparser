...
95.95.95.95     95.95.95.95     98          0x8000a441 0x006677 5
96.96.96.96     96.96.96.96     1045        0x80008c65 0x004f09 4
100.100.100.100 100.100.100.100 102         0x80001b04 0x004061 5

                Type-10 Opaque Link Area Link States (Area 0)

Link ID         ADV Router      Age         Seq#       Checksum Opaque ID
1.0.0.0         25.97.1.1       54          0x8003b136 0x009cb2        0
1.0.0.0         95.95.95.95     90          0x8000f3ee 0x001a3b        0
1.0.0.0         96.96.96.96     1045        0x80045c8f 0x0093ac        0
1.0.0.0         100.100.100.100 541         0x80000079 0x006c3a        0
1.0.0.5         95.95.95.95     97          0x800040af 0x00019a        5
1.0.0.6         25.97.1.1       3600        0x80055266 0x0033a9        6
1.0.0.6         95.95.95.95     98          0x80000001 0x000da0        6
1.0.0.6         96.96.96.96     1045        0x80044e2c 0x0023f8        6
1.0.0.6         100.100.100.100 26          0x80000079 0x000b06        6
1.0.0.7         25.97.1.1       54          0x8003b05e 0x006f08        7
1.0.0.7         100.100.100.100 98          0x80000006 0x00ced8        7
1.0.0.8         25.97.1.1       79          0x8000f551 0x00a29e        8
'''}
    ...
    def test_empty(self):
        ...
        obj = ShowOspfDatabase(device=self.device1)
        with self.assertRaises(SchemaEmptyParserError):
            parsed_output = obj.parse()
