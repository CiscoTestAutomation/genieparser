...
L    10.10.10.255/32 is directly connected, 5w6d, Loopback2112
    ...
    expected_output = {'vrf': {'default': {'address_family': {'ipv4': {'routes': {'0.0.0.0/0': {'active': True,
                                                                                                'metric': 1,
                                                                                  ...
                                                                                  '1.1.1.1/32': {'active': True,
                                                                                                 'next_hop': {'outgoing_interface': {'Loopback100': {'outgoing_interface': 'Loopback100',
                                                                                                                                                     'updated': '5w6d'}}},
                                                                                                 'route': '1.1.1.1/32',
                                                                                                 'source_protocol': 'local',
                                                                                                 'source_protocol_codes': 'L'},
                                                                                  '10.1.1.0/24': {'active': True,
                                                                                                  'metric': 66036,
                                                                                                  'next_hop': {'next_hop_list': {1: {'index': 1,
                                                                                                                                     'next_hop': '172.16.0.88',
                                                                                                                                     'outgoing_interface': 'Bundle-Ether1',
                                                                                  ...
                                                                                  '10.10.10.21/32': {'active': True,
                                                                                                     ...
                                                                                                     'source_protocol_codes': 'O '
                                                                                                     'E2'},
                                                                                  '10.10.10.255/32': {'active': True,
                                                                                                      'next_hop': {'outgoing_interface': {'Loopback2112': {'outgoing_interface': 'Loopback2112',
                                                                                                                                                           'updated': '5w6d'}}},
