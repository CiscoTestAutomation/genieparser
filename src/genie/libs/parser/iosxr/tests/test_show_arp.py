...
class test_show_arp_traffic_detail(unittest.TestCase):
		...
		golden_parsed_output_2 = {
			'0/0/CPU0': {
				'statistics': {
					'in_requests_pkts': 6555,
					'in_replies_pkts': 61292,
					'unsolicited': 0,
					'out_requests_pkts': 619,
					'out_replies_pkts': 6581,
					'out_proxy': 0,
					'out_local_proxy': 0,
					'out_gratuitous_pkts': 24,
					'subscriber_intf_requests': 0,
					'subscriber_intf_replies': 0,
					'subscriber_intf_gratuitous': 0,
					'resolve_rcvd_requests': 28,
					'resolve_dropped_requests': 28,
					'out_of_memory_errors': 0,
					'no_buffers_errors': 0,
					'out_of_subnet_errors': 0,
				},
			...
			'0/RP0/CPU0': {
				'statistics': {
					'in_requests_pkts': 29510712,
					'in_replies_pkts': 1662536,
					'unsolicited': 0,
					'out_requests_pkts': 1,
					'out_replies_pkts': 13642,
					'out_proxy': 0,
					'out_local_proxy': 0,
					'out_gratuitous_pkts': 2,
					'subscriber_intf_requests': 0,
