...
class test_show_bgp_instance_all_all_all(unittest.TestCase):
    ...
    golden_output_2 = {'execute.return_value': '''
            ...
            BGP router identifier 192.168.99.26, local AS number 65001
            BGP generic scan interval 60 secs
            Non-stop routing is enabled
            BGP table state: Active
            Table ID: 0xe0800000   RD version: 181
            BGP main routing table version 181
            BGP NSR Initial initsync version 29 (Reached)
            BGP NSR/ISSU Sync-Group versions 0/0
            BGP scan interval 60 secs
            ...
            Origin codes: i - IGP, e - EGP, ? - incomplete
            Network            Next Hop            Metric LocPrf Weight Path
            * i1000::1/128        192.168.99.11            0    100      0 65000 ?
            *>i                   192.168.99.12            0    100      0 65000 ?
            * i1000::2/128        192.168.99.11            0    100      0 65000 ?
            *>i                   192.168.99.12            0    100      0 65000 ?
            * i1000::3/128        192.168.99.11            0    100      0 ?
            *>i                   192.168.99.12            0    100      0 ?
            * i1000::4/128        192.168.99.11            0    100      0 ?
            *>i                   192.168.99.12            0    100      0 ?
            * i1000::5/128        192.168.99.21            0    100      0 ?
            *>i                   192.168.99.12            0    100      0 ?
            * i1000::6/128        192.168.99.22            0    100      0 ?
            *>i                   192.168.99.12            0    100      0 ?
            *>i1000::7/128        192.168.99.11            0    100      0 ?
            * i                   192.168.99.23            0    100      0 ?
            * i1000::8/128        192.168.99.11            0    100      0 ?
            *>i                   192.168.99.24            0    100      0 ?
            *> 1000::10/128       ::                       0         32768 ?
            * i1000::55/128       192.168.99.21            0    100      0 ?
            *>i                   192.168.99.12            0    100      0 ?
            * i1000::66/128       192.168.99.22            0    100      0 ?
            *>i                   192.168.99.12            0    100      0 ?
            *>i1000::77/128       192.168.99.11            0    100      0 ?
            * i                   192.168.99.23            0    100      0 ?
            * i1000::88/128       192.168.99.24            0    100      0 ?
            *>i                   192.168.99.12            0    100      0 ?
            * i2001:db8:12::/64   192.168.99.11            0    100      0 65000 ?
            *>i                   192.168.99.12            0    100      0 65000 ?
            * i2001:db8:13::/64   192.168.99.11            0    100      0 ?
            *>i                   192.168.99.12            0    100      0 ?
            * i2001:db8:24::/64   192.168.99.11            0    100      0 ?
            *>i                   192.168.99.12            0    100      0 ?
            * i2001:db8:34::/64   192.168.99.11            0    100      0 ?
            *>i                   192.168.99.12            0    100      0 ?
            * i2001:db8:35::/64   192.168.99.11            0    100      0 ?
            *>i                   192.168.99.12            0    100      0 ?
            * i2001:db8:52::/64   192.168.99.11            0    100      0 65000 ?
            *>i                   192.168.99.12            0    100      0 65000 ?
            * i2001:db8:56::/64   192.168.99.21            0    100      0 ?
            *>i                   192.168.99.12            0    100      0 ?
            * i2001:db8:67::/64   192.168.99.22            0    100      0 ?
            *>i                   192.168.99.12            0    100      0 ?
            *>i2001:db80:67::/64  192.168.99.11            0    100      0 ?
            * i                   192.168.99.23            0    100      0 ?
            * i2001:db80:78::/64  192.168.99.11            0    100      0 ?
            *>i                   192.168.99.24            0    100      0 ?
            * i2001:db80:89::/64  192.168.99.24            0    100      0 ?
            *>i                   192.168.99.12            0    100      0 ?
            * i2001:db80:410::/64 192.168.99.11            0    100      0 ?
            * i                   192.168.99.12            0    100      0 ?
            *>                    ::                       0         32768 ?
            *> 2001:db80:910::/64 ::                       0         32768 ?

            Processed 26 prefixes, 51 paths
            ...
            Non-stop routing is enabled
            BGP table state: Active
            Table ID: 0xe0000000   RD version: 335
            BGP main routing table version 335
            BGP NSR Initial initsync version 24 (Reached)
            BGP NSR/ISSU Sync-Group versions 0/0
            BGP scan interval 60 secs
            ...
            Origin codes: i - IGP, e - EGP, ? - incomplete
            Network            Next Hop            Metric LocPrf Weight Path
            * i55.55.55.55/32     192.168.99.21            0    100      0 ?
            *>i                   192.168.99.11            0    100      0 ?
            * i66.66.66.66/32     192.168.99.22            0    100      0 ?
            *>i                   192.168.99.11            0    100      0 ?
            * i77.77.77.77/32     192.168.99.23            0    100      0 ?
            *>i                   192.168.99.11            0    100      0 ?
            *>i88.88.88.88/32     192.168.99.24            0    100      0 ?
            * i                   192.168.99.11            0    100      0 ?
            * i192.168.0.0/30     192.168.99.11            0    100      0 ?
            *>i                   192.168.99.12            0    100      0 ?
            *>i192.168.0.4/30     192.168.99.11            0    100      0 ?
            * i                   192.168.99.11            0    100      0 ?
            * i192.168.0.8/30     192.168.99.21            0    100      0 ?
            *>i                   192.168.99.11            0    100      0 ?
            * i192.168.0.12/30    192.168.99.22            0    100      0 ?
            *>i                   192.168.99.11            0    100      0 ?
            * i192.168.0.16/30    192.168.99.23            0    100      0 ?
            *>i                   192.168.99.11            0    100      0 ?
            *>i192.168.0.20/30    192.168.99.25            0    100      0 ?
            * i                   192.168.99.11            0    100      0 ?
            *> 192.168.0.24/30    0.0.0.0                  0         32768 ?
            *> 192.168.0.28/30    0.0.0.0                  0         32768 ?
            * i                   192.168.99.12            0    100      0 ?
            * i                   192.168.99.12            0    100      0 ?
            * i192.168.10.0/30    192.168.10.5             0    100      0 65000 ?
            *>i                   192.168.10.9             0    100      0 65000 ?
            *>i192.168.10.4/30    192.168.99.11            0    100      0 ?
            * i                   192.168.99.11            0    100      0 ?
            * i192.168.10.8/30    192.168.99.12            0    100      0 ?
            *>i                   192.168.99.12            0    100      0 ?
            * i192.168.52.0/24    192.168.10.5             0    100      0 65000 ?
            *>i                   192.168.10.9                  100      0 65000 ?
            * i192.168.99.1/32    192.168.10.5             0    100      0 65000 ?
            *>i                   192.168.10.9                  100      0 65000 ?
            * i192.168.99.2/32    192.168.10.5                  100      0 65000 ?
            *>i                   192.168.10.9             0    100      0 65000 ?
            *>i192.168.99.11/32   192.168.99.11            0    100      0 ?
            * i                   192.168.99.11            0    100      0 ?
            * i192.168.99.12/32   192.168.99.12            0    100      0 ?
            *>i                   192.168.99.12            0    100      0 ?
            * i192.168.99.21/32   192.168.99.21            0    100      0 ?
            *>i                   192.168.99.11            0    100      0 ?
            * i192.168.99.22/32   192.168.99.22            0    100      0 ?
            *>i                   192.168.99.11            0    100      0 ?
            * i192.168.99.23/32   192.168.99.23            0    100      0 ?
            *>i                   192.168.99.11            0    100      0 ?
            *>i192.168.99.24/32   192.168.99.24            0    100      0 ?
            * i                   192.168.99.11            0    100      0 ?
            *>i192.168.99.25/32   192.168.99.25            0    100      0 ?
            * i                   192.168.99.11            0    100      0 ?
            *> 192.168.99.26/32   0.0.0.0                  0         32768 ?
            *> 192.168.100.0/24   0.0.0.0                  0         32768 ?
            *> 192.168.111.0/24   0.0.0.0                  0         32768 ?
            * i210.234.254.1/32   192.168.10.5             0    100      0 65000 ?
            *>i                   192.168.10.9             0    100      0 65000 ?

            Processed 29 prefixes, 55 paths
            ...
            *> 2001:db80:910::/64 ::                       0         32768 ?
            ...
            BGP table state: Active
            Table ID: 0x0   RD version: 0
            BGP main routing table version 1107
            BGP NSR Initial initsync version 179 (Reached)
            BGP NSR/ISSU Sync-Group versions 0/0
            BGP scan interval 60 secs
            ...
            *>i[1][5.5.5.5:1][01b0.aa77.a266.0000.0a00][4294967295]/184
                                192.168.99.21                 100      0 i
            * i                   192.168.99.21                 100      0 i
            Route Distinguisher: 6.6.6.6:1
            *>i[1][6.6.6.6:1][01b0.aa77.a266.0000.0a00][4294967295]/184
                                192.168.99.22                 100      0 i
            * i                   192.168.99.22                 100      0 i
            Route Distinguisher: 192.168.99.21:0
            *>i[4][01b0.aa77.a266.0000.0a00][32][192.168.99.21]/128
                                192.168.99.21                 100      0 i
            * i                   192.168.99.21                 100      0 i
            Route Distinguisher: 192.168.99.21:100
            *>i[1][0100.0000.0000.0000.0000][0]/120
                                192.168.99.21                 100      0 i
            * i                   192.168.99.21                 100      0 i
            *>i[3][0][32][192.168.99.21]/80
                                192.168.99.21                 100      0 i
            * i                   192.168.99.21                 100      0 i
            Route Distinguisher: 192.168.99.21:1000
            *>i[1][01b0.aa77.a266.0000.0a00][0]/120
                                192.168.99.21                 100      0 i
            * i                   192.168.99.21                 100      0 i
            *>i[3][0][32][192.168.99.21]/80
                                192.168.99.21                 100      0 i
            * i                   192.168.99.21                 100      0 i
            Route Distinguisher: 192.168.99.21:1401
            *>i[1][0100.0000.0000.0000.0000][0]/120
                                192.168.99.21                 100      0 i
            * i                   192.168.99.21                 100      0 i
            *>i[3][0][32][192.168.99.21]/80
                                192.168.99.21                 100      0 i
            * i                   192.168.99.21                 100      0 i
            Route Distinguisher: 192.168.99.21:1403
            *>i[1][0100.0000.0000.0000.0000][0]/120
                                192.168.99.21                 100      0 i
            * i                   192.168.99.21                 100      0 i
            *>i[3][0][32][192.168.99.21]/80
                                192.168.99.21                 100      0 i
            * i                   192.168.99.21                 100      0 i
            Route Distinguisher: 192.168.99.21:1405
            *>i[1][0100.0000.0000.0000.0000][0]/120
                                192.168.99.21                 100      0 i
            * i                   192.168.99.21                 100      0 i
            *>i[3][0][32][192.168.99.21]/80
                                192.168.99.21                 100      0 i
            * i                   192.168.99.21                 100      0 i
            Route Distinguisher: 192.168.99.21:1407
            *>i[1][0100.0000.0000.0000.0000][0]/120
                                192.168.99.21                 100      0 i
            * i                   192.168.99.21                 100      0 i
            *>i[3][0][32][192.168.99.21]/80
                                192.168.99.21                 100      0 i
            * i                   192.168.99.21                 100      0 i
            Route Distinguisher: 192.168.99.21:1410
            *>i[1][0100.0000.0000.0000.0000][0]/120
                                192.168.99.21                 100      0 i
            * i                   192.168.99.21                 100      0 i
            *>i[3][0][32][192.168.99.21]/80
                                192.168.99.21                 100      0 i
            * i                   192.168.99.21                 100      0 i
            Route Distinguisher: 192.168.99.21:2000
            *>i[1][01b0.aa77.a266.0000.0a00][5556]/120
                                192.168.99.21                 100      0 i
            * i                   192.168.99.21                 100      0 i
            Route Distinguisher: 192.168.99.22:0
            *>i[4][01b0.aa77.a266.0000.0a00][32][192.168.99.22]/128
                                192.168.99.22                 100      0 i
            * i                   192.168.99.22                 100      0 i
            Route Distinguisher: 192.168.99.22:100
            *>i[1][0100.0000.0000.0000.0000][0]/120
                                192.168.99.22                 100      0 i
            * i                   192.168.99.22                 100      0 i
            *>i[3][0][32][192.168.99.22]/80
                                192.168.99.22                 100      0 i
            * i                   192.168.99.22                 100      0 i
            Route Distinguisher: 192.168.99.22:1000
            *>i[1][01b0.aa77.a266.0000.0a00][0]/120
                                192.168.99.22                 100      0 i
            * i                   192.168.99.22                 100      0 i
            *>i[3][0][32][192.168.99.22]/80
                                192.168.99.22                 100      0 i
            * i                   192.168.99.22                 100      0 i
            Route Distinguisher: 192.168.99.22:1401
            *>i[1][0100.0000.0000.0000.0000][0]/120
                                192.168.99.22                 100      0 i
            * i                   192.168.99.22                 100      0 i
            *>i[3][0][32][192.168.99.22]/80
                                192.168.99.22                 100      0 i
            * i                   192.168.99.22                 100      0 i
            Route Distinguisher: 192.168.99.22:1403
            *>i[1][0100.0000.0000.0000.0000][0]/120
                                192.168.99.22                 100      0 i
            * i                   192.168.99.22                 100      0 i
            *>i[3][0][32][192.168.99.22]/80
                                192.168.99.22                 100      0 i
            * i                   192.168.99.22                 100      0 i
            Route Distinguisher: 192.168.99.22:1405
            *>i[1][0100.0000.0000.0000.0000][0]/120
                                192.168.99.22                 100      0 i
            * i                   192.168.99.22                 100      0 i
            *>i[3][0][32][192.168.99.22]/80
                                192.168.99.22                 100      0 i
            * i                   192.168.99.22                 100      0 i
            Route Distinguisher: 192.168.99.22:1407
            *>i[1][0100.0000.0000.0000.0000][0]/120
                                192.168.99.22                 100      0 i
            * i                   192.168.99.22                 100      0 i
            *>i[3][0][32][192.168.99.22]/80
                                192.168.99.22                 100      0 i
            * i                   192.168.99.22                 100      0 i
            Route Distinguisher: 192.168.99.22:1410
            *>i[1][0100.0000.0000.0000.0000][0]/120
                                192.168.99.22                 100      0 i
            * i                   192.168.99.22                 100      0 i
            *>i[3][0][32][192.168.99.22]/80
                                192.168.99.22                 100      0 i
            * i                   192.168.99.22                 100      0 i
            Route Distinguisher: 192.168.99.22:2000
            *>i[1][01b0.aa77.a266.0000.0a00][5556]/120
                                192.168.99.22                 100      0 i
            * i                   192.168.99.22                 100      0 i
            Route Distinguisher: 192.168.99.23:0
            *>i[4][01b0.aa77.a266.0000.0b00][32][192.168.99.23]/128
                                192.168.99.23                 100      0 i
            * i                   192.168.99.23                 100      0 i
            Route Distinguisher: 192.168.99.23:1
            *>i[1][192.168.99.23:1][01b0.aa77.a266.0000.0b00][4294967295]/184
                                192.168.99.23                 100      0 i
            * i                   192.168.99.23                 100      0 i
            Route Distinguisher: 192.168.99.23:100
            *>i[1][0100.0000.0000.0000.0000][0]/120
                                192.168.99.23                 100      0 i
            * i                   192.168.99.23                 100      0 i
            *>i[3][0][32][192.168.99.23]/80
                                192.168.99.23                 100      0 i
            * i                   192.168.99.23                 100      0 i
            Route Distinguisher: 192.168.99.23:1000
            *>i[1][01b0.aa77.a266.0000.0b00][0]/120
                                192.168.99.23                 100      0 i
            * i                   192.168.99.23                 100      0 i
            *>i[3][0][32][192.168.99.23]/80
                                192.168.99.23                 100      0 i
            * i                   192.168.99.23                 100      0 i
            Route Distinguisher: 192.168.99.23:1403
            *>i[1][0100.0000.0000.0000.0000][0]/120
                                192.168.99.23                 100      0 i
            * i                   192.168.99.23                 100      0 i
            *>i[3][0][32][192.168.99.23]/80
                                192.168.99.23                 100      0 i
            * i                   192.168.99.23                 100      0 i
            Route Distinguisher: 192.168.99.23:1405
            *>i[1][0100.0000.0000.0000.0000][0]/120
                                192.168.99.23                 100      0 i
            * i                   192.168.99.23                 100      0 i
            *>i[3][0][32][192.168.99.23]/80
                                192.168.99.23                 100      0 i
            * i                   192.168.99.23                 100      0 i
            Route Distinguisher: 192.168.99.23:1407
            *>i[1][0100.0000.0000.0000.0000][0]/120
                                192.168.99.23                 100      0 i
            * i                   192.168.99.23                 100      0 i
            *>i[3][0][32][192.168.99.23]/80
                                192.168.99.23                 100      0 i
            * i                   192.168.99.23                 100      0 i
            Route Distinguisher: 192.168.99.23:1410
            *>i[1][0100.0000.0000.0000.0000][0]/120
                                192.168.99.23                 100      0 i
            * i                   192.168.99.23                 100      0 i
            *>i[3][0][32][192.168.99.23]/80
                                192.168.99.23                 100      0 i
            * i                   192.168.99.23                 100      0 i
            Route Distinguisher: 192.168.99.24:0
            *>i[4][01b0.aa77.a266.0000.0b00][32][192.168.99.24]/128
                                192.168.99.24                 100      0 i
            * i                   192.168.99.24                 100      0 i
            Route Distinguisher: 192.168.99.24:1
            *>i[1][192.168.99.24:1][01b0.aa77.a266.0000.0b00][4294967295]/184
                                192.168.99.24                 100      0 i
            * i                   192.168.99.24                 100      0 i
            Route Distinguisher: 192.168.99.24:100
            *>i[1][0100.0000.0000.0000.0000][0]/120
                                192.168.99.24                 100      0 i
            * i                   192.168.99.24                 100      0 i
            *>i[3][0][32][192.168.99.24]/80
                                192.168.99.24                 100      0 i
            * i                   192.168.99.24                 100      0 i
            Route Distinguisher: 192.168.99.24:1000
            *>i[1][01b0.aa77.a266.0000.0b00][0]/120
                                192.168.99.24                 100      0 i
            * i                   192.168.99.24                 100      0 i
            *>i[3][0][32][192.168.99.24]/80
                                192.168.99.24                 100      0 i
            * i                   192.168.99.24                 100      0 i
            Route Distinguisher: 192.168.99.24:1403
            *>i[1][0100.0000.0000.0000.0000][0]/120
                                192.168.99.24                 100      0 i
            * i                   192.168.99.24                 100      0 i
            *>i[3][0][32][192.168.99.24]/80
                                192.168.99.24                 100      0 i
            * i                   192.168.99.24                 100      0 i
            Route Distinguisher: 192.168.99.24:1405
            *>i[1][0100.0000.0000.0000.0000][0]/120
                                192.168.99.24                 100      0 i
            * i                   192.168.99.24                 100      0 i
            *>i[3][0][32][192.168.99.24]/80
                                192.168.99.24                 100      0 i
            * i                   192.168.99.24                 100      0 i
            Route Distinguisher: 192.168.99.24:1407
            *>i[1][0100.0000.0000.0000.0000][0]/120
                                192.168.99.24                 100      0 i
            * i                   192.168.99.24                 100      0 i
            *>i[3][0][32][192.168.99.24]/80
                                192.168.99.24                 100      0 i
            * i                   192.168.99.24                 100      0 i
            Route Distinguisher: 192.168.99.24:1410
            *>i[1][0100.0000.0000.0000.0000][0]/120
                                192.168.99.24                 100      0 i
            * i                   192.168.99.24                 100      0 i
            *>i[3][0][32][192.168.99.24]/80
                                192.168.99.24                 100      0 i
            * i                   192.168.99.24                 100      0 i
            Route Distinguisher: 192.168.99.26:0 (default for vrf ES:GLOBAL)
            *> [1][192.168.99.26:1][0000.0100.0000.2526.0000][4294967295]/184
                                0.0.0.0                                0 i
            *> [4][0000.0100.0000.2526.0000][32][192.168.99.26]/128
                                0.0.0.0                                0 i
            *>i[4][01b0.aa77.a266.0000.0a00][32][192.168.99.21]/128
                                192.168.99.21                 100      0 i
            *>i[4][01b0.aa77.a266.0000.0a00][32][192.168.99.22]/128
            ...
            *>i[4][01b0.aa77.a266.0000.0b00][32][192.168.99.24]/128
                                192.168.99.24                 100      0 i
            Route Distinguisher: 192.168.99.26:100 (default for vrf Mansion-100)
            *> [1][0000.0100.0000.2526.0000][0]/120
                                0.0.0.0                                0 i
            *> [1][0100.0000.0000.0000.0000][0]/120
                                0.0.0.0                                0 i
            * i                   192.168.99.21                 100      0 i
            * i                   192.168.99.22                 100      0 i
            * i                   192.168.99.23                 100      0 i
            * i                   192.168.99.24                 100      0 i
            *> [2][0][48][b0aa.77a2.663f][0]/104
                                0.0.0.0                                0 i
            *> [2][0][48][b0aa.77a2.663f][32][192.168.100.52]/136
                                0.0.0.0                                0 i
            *>i[3][0][32][192.168.99.21]/80
                                192.168.99.21                 100      0 i
            *>i[3][0][32][192.168.99.22]/80
            ...
            *>i[3][0][32][192.168.99.24]/80
                                192.168.99.24                 100      0 i
            *> [3][0][32][192.168.99.26]/80
                                0.0.0.0                                0 i
            Route Distinguisher: 192.168.99.26:1000 (default for vrf au-Biz)
            *> [1][0000.0100.0000.2526.0000][0]/120
                                0.0.0.0                                0 i
            *>i[1][01b0.aa77.a266.0000.0a00][0]/120
                                192.168.99.21                 100      0 i
            * i                   192.168.99.22                 100      0 i
            *>i[1][01b0.aa77.a266.0000.0a00][4294967295]/120
                                192.168.99.21                 100      0 i
            * i                   192.168.99.22                 100      0 i
            * i[1][01b0.aa77.a266.0000.0b00][0]/120
                                192.168.99.23                 100      0 i
            *>i                   192.168.99.24                 100      0 i
            * i[1][01b0.aa77.a266.0000.0b00][4294967295]/120
                                192.168.99.23                 100      0 i
            *>i                   192.168.99.24                 100      0 i
            *>i[3][0][32][192.168.99.21]/80
                                192.168.99.21                 100      0 i
            ...
            *> [3][0][32][192.168.99.26]/80
                                0.0.0.0                                0 i
            Route Distinguisher: 192.168.99.26:1401 (default for vrf au-hikari-home-1G)
            *> [1][0100.0000.0000.0000.0000][0]/120
                                0.0.0.0                                0 i
            * i                   192.168.99.21                 100      0 i
            * i                   192.168.99.22                 100      0 i
            ...
            *> [3][0][32][192.168.99.26]/80
                                0.0.0.0                                0 i
            Route Distinguisher: 192.168.99.26:1403 (default for vrf UQ_BS)
            *> [1][0100.0000.0000.0000.0000][0]/120
                                0.0.0.0                                0 i
            * i                   192.168.99.21                 100      0 i
            * i                   192.168.99.22                 100      0 i
            ...
            *> [3][0][32][192.168.99.26]/80
                                0.0.0.0                                0 i
            Route Distinguisher: 192.168.99.26:1405 (default for vrf au-hikari-mansion-giga)
            *> [1][0100.0000.0000.0000.0000][0]/120
                                0.0.0.0                                0 i
            * i                   192.168.99.21                 100      0 i
            * i                   192.168.99.22                 100      0 i
            ...
            *> [3][0][32][192.168.99.26]/80
                                0.0.0.0                                0 i
            Route Distinguisher: 192.168.99.26:1407 (default for vrf au-Hikari-Business)
            *> [1][0100.0000.0000.0000.0000][0]/120
                                0.0.0.0                                0 i
            * i                   192.168.99.21                 100      0 i
            * i                   192.168.99.22                 100      0 i
            ...
            *> [3][0][32][192.168.99.26]/80
                                0.0.0.0                                0 i
            Route Distinguisher: 192.168.99.26:1410 (default for vrf JCOM)
            *> [1][0100.0000.0000.0000.0000][0]/120
                                0.0.0.0                                0 i
            * i                   192.168.99.21                 100      0 i
            * i                   192.168.99.22                 100      0 i
            ...
            *> [3][0][32][192.168.99.26]/80
                                0.0.0.0                                0 i
            Route Distinguisher: 192.168.99.26:2000 (default for vrf VPWS:2000)
            *> [1][0000.0100.0000.2526.0000][5960]/120
                                0.0.0.0                                0 i
            *>i[1][01b0.aa77.a266.0000.0a00][5556]/120
                                192.168.99.21                 100      0 i
            * i                   192.168.99.22                 100      0 i
            ...
            * i                   192.168.99.22                 100      0 i
            ...
            Processed 118 prefixes, 208 paths
            RP/0/RP0/CPU0:ML26#
