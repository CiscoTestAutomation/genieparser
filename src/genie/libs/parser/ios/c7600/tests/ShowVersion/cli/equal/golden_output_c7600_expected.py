expected_output = {
    "version": {
        ...
        "controller": {"counts": 1, "serial": 4, "type": "Enhanced FlexWAN"},
        "cpu": {
            "implementation": "1284",
            "l2_cache": "512KB",
            "name": "SR71000",
        ...
        "interfaces": {"gigabit_ethernet": 52, "serial": 4, "virtual_ethernet": 1},
        "last_reload": {"reason": "abort at PC 0x433A11BC", "type": "Normal Reload"},
        "last_reset": "s/w",
        "main_mem": "983008",
        "memory": {
