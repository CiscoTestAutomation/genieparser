...
class test_show_ipv6_pim_bsr_election(unittest.TestCase):
                        ...
                        "rp": {
                            "bsr": {
                                "bsr": {
                                    ...
                                    "rpf_address": "FE80::20:1:2",
                                    "priority": 34,
                                    "rpf_interface": "Ethernet1/0"
                                }
                            }
                        }
                    }
    ...
    golden_output_mapping = {'execute.return_value': '''
    ...
    def test_empty(self):
        ...
        with self.assertRaises(SchemaEmptyParserError):
            parsed_output = obj.parse()
    def test_golden_bsr_mapping(self):
        self.maxDiff = None
        self.device = Mock(**self.golden_output_mapping)
        obj = ShowIpv6PimBsrElection(device=self.device)
        parsed_output = obj.parse()
        self.assertEqual(parsed_output, self.golden_parsed_mapping)
...
class test_show_ipv6_pim_bsr_candidate_rp(unittest.TestCase):
        ...
        golden_output_xx = {'execute.return_value': '''
        ...
        golden_parsed_output_candidate_4 = {
            "vrf": {
                "default": {
                    "address_family": {
                        "ipv6": {
        ...
        def test_golden_candidate_rp_4(self):
            self.maxDiff = None
            self.device = Mock(**self.golden_output_xx)
            obj = ShowIpv6PimBsrCandidateRp(device=self.device)
            parsed_output = obj.parse()
            self.assertEqual(parsed_output, self.golden_parsed_output_candidate_4)
