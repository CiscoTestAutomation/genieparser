...
class TestShowInterfaces(unittest.TestCase):
    ...
    golden_parsed_output_2 = {
        ...
        'Virtual-Template1': {
            ...
            'rxload': '1/255',
            'txload': '1/255',
            'type': 'Virtual Template interface',
        },
    }
    ...
    golden_output_2 = {'execute.return_value': '''
        ...
        Last clearing of "show interface" counters never
        Input queue: 0/75/0/0 (size/max/drops/flushes); Total output drops: 553
        Queueing strategy: Per VC Queueing
        5 minute input rate 0 bits/sec, 0 packets/sec
        5 minute output rate 3000 bits/sec, 2 packets/sec
        637454 packets input, 54822182 bytes, 0 no buffer
        Received 0 broadcasts (0 IP multicasts)
        0 runts, 0 giants, 0 throttles
        0 input errors, 0 CRC, 0 frame, 0 overrun, 0 ignored, 0 abort
        2066120 packets output, 295633641 bytes, 0 underruns
