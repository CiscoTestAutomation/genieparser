...
# Parser
from genie.libs.parser.viptela.show_system_status import ShowSystemStatus
...
#   * 'show system status'
# ============================================
class TestShowSystemStatus(unittest.TestCase):
    ...
    def test_empty(self):
        ...
        obj = ShowSystemStatus(device=self.device)
