expected_output = {
    'version': {'asa_model': 'ASAv10',
             'asa_version': '9.8(4)10',
             'asdm_version': '7.8(2)',
             'bios_flash_firmware': 'Hub @ 0x0, 0KB',
             'boot_config_file': 'startup-config',
             'compiled_by': 'builders',
             'compiled_date': 'Tue 20-Aug-19 12:46 PDT',
             'disks': {'Internal': {'type_of_disk': 'ATA Compact Flash',
                                    'disk_size': '8192MB'},
                       'Slot 1': {'disk_size': '8192MB',
             ...
             'image_type': 'Release',
             'interfaces': {'0': {'interface': 'Management0/0',
                                  'intf_irq': '11',
             ...
             'licensed_features': {'advanced_endpoint_assessment': 'Disabled',
