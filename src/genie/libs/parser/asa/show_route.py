...
class ShowRouteBgp(ShowRouteSchema):
    ...
    def cli(self, output=None):
        ...
        # clean_lines now holds a list of entries in a single line (easier for parsing)
        # Gateway of last resort is 185.79.24.44 to network 0.0.0.0
        # B        185.79.24.137 255.255.255.255 [20/0] via 185.79.26.15, 1w0d
        # B        185.79.24.138 255.255.255.255 [20/0] via 185.79.26.15, 1w0d
        # B        185.79.24.140 255.255.255.255 [20/0] via 185.79.26.45, 1w0d
        # B        185.79.24.141 255.255.255.255 [20/0] via 185.79.26.45, 1w0d
        # B        185.79.24.160 255.255.255.255 [20/5] via 185.79.26.21, 1w0d
        # B        185.79.24.161 255.255.255.255 [20/5] via 185.79.26.21, 1w0d
        # B        185.79.24.164 255.255.255.255 [20/5] via 185.79.26.21, 1w0d
        # B        185.79.24.165 255.255.255.255 [20/5] via 185.79.26.21, 1w0d
        # B        185.79.24.166 255.255.255.255 [20/0] via 185.79.26.33, 2d17h
        # B        185.79.24.252 255.255.255.255 [20/0] via 185.79.26.17, 1w0d
        # B        185.79.24.253 255.255.255.255 [20/0] via 185.79.26.17, 1w0d
