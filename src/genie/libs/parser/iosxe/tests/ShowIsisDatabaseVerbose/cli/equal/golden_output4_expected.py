                ...
                1: {
                    "r1.00-00": {
                        ...
                        "flex_algo": {
                            128: {
                                "alg_type": "SPF",
                                "exclude_any": ["0x00000000 0x00000000 0x00000002"],
                                "include_all": ["0x00000000 0x00000000 0x00000002"],
                                "include_any": ["0x00000000 0x00000000 0x00000002"],
                                "metric_type": "IGP",
                                "priority": 128,
                            },
                        },
                            ...
                            "r2.00": [
                                {
                                    ...
                                    "local_interface_id": 1,
                                    "remote_interface_id": 1,
                                    "interface_ipv6_address": "100:1:1:1:1:1:1:10",
                                    "neighbor_ipv6_address": "100:1:1:1:1:1:1:12",
                                },
                                {
                                    "neighbor_id": "r2.00",
                                    "metric": 10,
                                    ...
                                    "interface_ipv6_address": "101:1:1:1:1:1:1:10",
