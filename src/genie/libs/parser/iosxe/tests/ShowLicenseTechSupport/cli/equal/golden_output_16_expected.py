expected_output = {
    ...
    'communication_statistics': {
        ...
        'trust_sync': {
            'attempts': 'Total=2, Success=1, Fail=1',
            'failure_reason': 'Server error occurred: LS_LICENGINE_FAIL_TO_CONNECT',
            'last_failure_time': 'Nov 15 18:45:47 2024 UTC',
            'last_response': 'OK_TRY_AGAIN on Nov 15 18:45:47 2024 UTC',
            'last_success_time': 'Nov 15 18:43:15 2024 UTC',
            'ongoing_failure': 'Overall=1 Communication=0',
        },
        'usage_reporting': {
            'attempts': 'Total=0, Success=0, Fail=0',
            'failure_reason': '<none>',
