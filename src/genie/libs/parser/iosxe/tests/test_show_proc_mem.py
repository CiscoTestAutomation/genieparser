...
# iosxe show_lisp
# from genie.libs.parser.iosxe.show_lisp import ShowLispSessionGet schema idea from Yang Model Tree. 'pyang' package

from genie.libs.parser.iosxe.show_proc_mem import ShowProcessesMemoryPlatformSorted
