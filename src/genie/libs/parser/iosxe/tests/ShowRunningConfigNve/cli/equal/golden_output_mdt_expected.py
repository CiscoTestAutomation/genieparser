expected_output = {
    ...
    'vlans': {
        '101': {'evi': '101', 'vlan_type': 'access', 'vni': '10101'},
        '102': {'evi': '102', 'vlan_type': 'access', 'vni': '10102'},
        '201': {'evi': '201', 'vlan_type': 'access', 'vni': '10201'},
        '202': {'evi': '202', 'vlan_type': 'access', 'vni': '10202'},
        '901': {'vlan_type': 'core', 'vni': '50901'},
        '902': {'vlan_type': 'core', 'vni': '50902'}
    },
    'vrf': {
        'blue': {
            'address_family': {
                'ipv4': {
                    'rp_address': '10.2.255.255',
