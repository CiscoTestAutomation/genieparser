...
# iosxe show_bgp
from genie.libs.parser.iosxe.show_bgp import ShowBgpAllDetail,\
                                             ShowBgpAllSummary,\
...
class test_show_bgp_all_neighbors(unittest.TestCase):
    ...
    golden_parsed_output1 = {
        'list_of_neighbors': ['10.16.2.2', '10.36.3.3', '10.4.6.6', '10.66.6.6', '10.16.2.2', '10.36.3.3', '2001:DB8:4:6::6', '2001:DB8:20:4:6::6'],
        'vrf':
            {'default':
                {'neighbor':
                    {'10.16.2.2':
