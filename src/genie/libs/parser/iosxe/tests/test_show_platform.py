...
class test_show_env(unittest.TestCase):
    ...
    golden_parsed_output = {'critical_larams': 0,
         'day': '19',
         'load': {'five_min': '6%', 'five_secs': '4%/0%', 'one_min': '8%'},
         'major_alarms': 0,
         'minor_alarms': 0,
         'month': 'Oct',
         'sensor': {'Temp: Asic1': {'reading': '38 Celsius',
                                    'sensor_name': 'Temp: Asic1',
                                    'slot': '1',
                                    'state': 'Normal'},
                    'Temp: C2D C0': {'reading': '36 Celsius',
                                     'sensor_name': 'Temp: C2D C0',
                                     'slot': 'R1',
                                     'state': 'Normal'},
                    'Temp: C2D C1': {'reading': '33 Celsius',
                                     ...
                                     'slot': 'R1',
                                     'state': 'Normal'},
                    'Temp: CPP Rear': {'reading': '46 Celsius',
                                       'sensor_name': 'Temp: CPP Rear',
                                       'slot': 'F1',
                                       'state': 'Normal'},
...
class test_show_processes_cpu(unittest.TestCase):
    ...
    golden_parsed_output = {'day': '17',
 'five_min_cpu': 3,
 'five_sec_cpu_interrupts': 0,
 'five_sec_cpu_total': 1,
 'load': {'five_min': '3%', 'five_secs': '1%/0%', 'one_min': '2%'},
 'month': 'Oct',
