...
class ShowTcpProxyStatisticsSchema(MetaParser):
    ...
    schema = {
        'tcpproxy_statistics':{
            ...
            'syncache_added': int,
            'syncache_not_added_nat_entry_null': int,
            'syncache_not_added_mrkd_for_cleanup': int,
