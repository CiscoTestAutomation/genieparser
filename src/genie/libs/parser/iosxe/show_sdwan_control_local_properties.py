...
class ShowSdwanControlLocalPropertiesSchema(MetaParser):

    """ Schema for "show sdwan control local-properties" command """
    ...
    schema = {
        ...
        "enterprise_cert_status": str,
        "enterprise_cert_validity": str,
        "enterprise_cert_not_valid_before": str,
        "enterprise_cert_not_valid_after": str,
        "dns_name": str,
        "site_id": str,
        "domain_id": str,
        "protocol": str,
...
class ShowSdwanControlLocalProperties(ShowSdwanControlLocalPropertiesSchema):
