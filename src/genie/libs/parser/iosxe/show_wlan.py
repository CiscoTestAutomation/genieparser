...
class ShowWlanIdClientStatsSchema(MetaParser):
    ...
    schema = {
        Optional("client_delete"): {
            "aaa": {"server_not_ready": int, "server_unavailable": int},
            "accounting_fail": int,
            "acl_fail": int,
            "admin_deauth": int,
            "anchor": {
            ...
            "client": {
                ...
                "connection_lost": int,
                "decrypt_fail": int,
                "deleted_during_ha_recovery": int,
                "device_idle": int,
                "dhcp": int,
                "dot1x_timeout": int,
                "eap_id_timeout": int,
                ...
                "int_disable": int,
                "misc_reason": int,
                "not_allowed_by_assisted_roaming": int,
                "peer_trigger": int,
            ...
            "mobility": {"peer_delete": int, "tunnel_down": int, "wlan_down": int},
            "nack": {"ifid_exists": int, "ifid_mismatch": int},
            "nas_error": int,
            "no_ip": int,
            "no_operation": int,
            "policy": {
                "bind_fail": int,
                "fail": int,
                "manager_internal_error": int,
                "parameter_mismatch": int,
            },
            ...
            "web_auth_fail": int,
            "wired": {
                "client_cleanup_due_to_wgb_roaming": int,
                "vlan_change": int,
                "wbg_joins": int,
                "wgb_change": int,
                "wgb_delete": int,
            },
            "wpa": {"group_key_update_timeout": int, "key_exchange_timeout": int},
            "wrong_psk": int,
